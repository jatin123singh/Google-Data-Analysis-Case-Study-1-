...
#ride_time_m
Represent the total time of a bike ride,in minutes
...
* There's bigger volume of bikers in the afternon.
...
The data has been organized into a multiple CSV concatenating all the files from the dataset.

* Has your data been properly formatted?
yes, all the columns have their correct data type.

* What surprises did you discover in the data?
One of the main surprises is how members different from casuals when analyzed from weekdays. Also that members have less riding time than casuals.
...
1 Build a marketing campaign focusing on show how bikes help people to get to  ,while maintaining the planet green and avoid traffic. The ads could be show  on professional social networks.
